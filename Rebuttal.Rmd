...
#### 小さな変更
  ...
  投稿時にはIn pressだった論文が出版され、掲載巻号・ページが確定したため、修正しました (line 299)。
...
> 各試験区の実測値・試験区間差に関する記述を追加しました (line 51--56)。
...
> ご指摘に従い、具体的な記述が多くなるよう修正しました (line 9--21)。

２．P4L79この記述には引用が必要

> 引用文献を追加し、記述を修正しました (line 83--84, 261-262)。

３．P5L102,104など
Fig.2中の各パネルとそのキャプションのアルファベットはa～ｄの小文字であるが、本文はA～Ｄの大文字である。統一すべき。

> 修正しました (line 108, 110, 127)。
...
> Fig2b,dを比較した記述を追加しました (line 128--129)。
> Fig2の矢印を修正し、キャプションに記述を追加しました (line 337--338)。
...
> We rephrased some “interaction” to “statistical interaction” (line 11, 61, 234).
...
> We corrected the equation (line 92) and the abbreviated point (line 90, 104).


###### 3. Please clarify the definition of PSI-light and PSII-light?
Is there neutral light?

> We added description on the definition (line 101--103).
...
> We added some description (line 329-330), although readers must read the cited paper for complete understanding.
...
> The following sentence was rephrased so that the meaning of “potential” becomes clear (line 107--108).
...
> We added description on the “relative spectral distribution” (line 35-36).
