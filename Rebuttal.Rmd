...
#### 小さな変更
  ...
  投稿時にはIn pressだった論文が出版され、掲載巻号・ページが確定したため、修正しました (line 315)。
...
> 試験区間差に関する記述を追加しました (line 75--77)。
> 引用文献に記載されているため、論文としてアクセプトされていることは明確であると判断します。
...
> FRの割合に関する記述を追加しました (line 72)。
> PSII/PSI量比が光エネルギー分配の調節に重要であると考えられていますが、その他の機構が関与している可能性があります (追記箇所: line 191--192)。
...
> 「使えない光源だ」と判断しています。
> 強いて上げれば、広く標準的に使われているため、他の研究との比較が容易なことです。
...
> 光飽和 (高PFD・低CO2濃度) 条件での交互作用に関する記述を追加しました (line 179--186)。
...
> 引用文献を追加し、記述を修正しました (line 104--105, 278-289)。

３．P5L102,104など
Fig.2中の各パネルとそのキャプションのアルファベットはa～ｄの小文字であるが、本文はA～Ｄの大文字である。統一すべき。

> 修正しました (line 128, 130, 147)。
...
> Fig2b,dを比較した記述を追加しました (line 147--149)。
> Fig2の矢印を修正し、キャプションに記述を追加しました (line 353--354)。
...
> We rephrased the some “interaction” to “statistical interaction” (line 11, 88).
...
> We corrected the equation (line 113) and the abbreviated point (line 111).

3. Please clarify the definition of PSI-light and PSII-light?
Is there neutral light?

> We added description on the definition (line 122--123).
> “Neutral light” exists depending on the leaf as mentioned in the manuscript (line 144--149).

4. Figure 1 is very informative. Please clarify how to calculate it in detail.
Is “typical” correct?  Is “example” better?

> We added some description (line 345-346).
> As similar spectrum was drawn in several earlier papers, the shown spectrum may be “typical”.

5. What is “potential ETR at PSI or PSII” in Line 100?

> The following sentence describes the meaning of “potential” (line 126--128).
...
> We added description on the “relative spectral distribution” (line 59).
> “Spectral distribution” consists of two factors; PFD---integral of the “spectral distribution”---and light quality---the “relative spectral distribution”.
