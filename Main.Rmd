...
# How the interactions are generated
  ...
  Light energy absorbed by a leaf drives photosynthetic electron transport, and thereby the photosynthetic carbon **fixation**.
  ...
  Therefore, when the excess energy is distributed to PSII, the energy distribution to PSI limits the ETR and light use efficiency (i.e. photochemical quantum yield) of PSII is lowered (Fig. 1A) and *vice versa* (Fig. 1B).
  ...
  **The imbalance between the photosystems ** can be caused by the SPD of light.
  These photosystems represent different light absorption spectral distributions due to the difference in the compositions of binding pigments, mainly chlorophyll (chl) *a* and *b*.
  ...
  Apparently, the distribution is affected by the stoichiometry of the membrane composition, vulneerable to the SPD of light during the leaf growth [@].
...
# Where and When the interactions should be cared.
  ...
  For instance, assimilation light provided by the most of the artificial light sources contain little FR (Fig. 3).
  ...
  On contrary, sunlight, いくつかのメタハラ, and offcourse FR LEDs contain much FR (Fig. 3), thus they serve as PSI-light.
  ...
  模したつもりで模すことができてないな。When imitating natural environemt (i.e. sunlight), this might be strongly 
