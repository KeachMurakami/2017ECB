---
title: "A practical guide for selecting the spectral photon flux density distribution of light for comparing photosynthetic rates of leaves grown under different spectral light environments"
...
# Introduction
  ...
  Based on the results obtained from the measurement under BR-light, the prospective leaf photosynthetic rate of WFR-plants may be evaluated to be smaller than that of W-plants despite the comparable rates under sunlight.
  ...
  In this short article, we introduce a plausible cause of the interaction---**the excitation balance between the photosystems**.
  ...
  The SPD of light affects photosynthesis through **several mechanisms other than the excitation balance**, such as stomatal responses [@Shimazaki_et_al2007AnnRev], photoinhibition [@Zavafer_et_al2015JPP], and vertical PFD profile within a leaf [@Terashima_et_al2009PCP].
...
# How the interaction is generated? **(見出し軽すぎ)**
  ...
  The excitation energy transferred to the reaction centers of the photosystems is consumed by the photochemical reactions.
  ...
  Within the chlorophyll (chl) absorption band (approximately 350--750 nm), longer wavelengths of light (> 680--690 nm) are estimated to be preferentially absorbed by PSI, and PSI is drastically overexcited [Fig. XXX; @Evans_Anderson1987BBA; @Hogewoning_et_al2012PC; @Wientjes_et_al2013BBA; @Laisk_et_al2014BBA].
  ...
  In contrast, monochromatic light at shorter wavelengths (< 680--690 nm) is estimated to be preferentially absorbed by PSII, or evenly absorbed by both photosystems [Fig. XXX; @Evans_Anderson1987BBA; @Hogewoning_et_al2012PC; @Wientjes_et_al2013BBA; @Laisk_et_al2014BBA].
  ...
  **This categorization is defined for a given leaf in the relative scale, not in the absolute scale.「absolute」と「relative」が何を指しているのかなど，，もう少し具体的に書きたい。ある特定の葉に対してのみ定義できる**
  ...
  **They demonstrated that the interaction cannot occur only in the case growth light was used as measuring light but also in the case the other SPDs of light was used.**
  ...
  The risk of the biased evaluation by the use of BR-light for *P*~n~ measurements was clearly demonstrated.
...
**Acknowledgements**
  ...
  The authors are grateful to Dr Sander W. Hogewoning (Plant Lighting B.V., the Netherlands) for his kindness for 
