...
# Introduction
  ...
  To eliminate this direct effect from the comparison, the photosynthetic rates are measured under identical SPD conditions in the agricultural and horticultural researches.
  The most prevailing light source might be the commercial blue+red LED light source.
...
# How the photosynthetic responses should be measured?
  ...
  For instance, when the difference in the resultant growth between the treatments are analyzed and the *P*~n~ is used for the explanatory factor, respective growth light must be used for ML.
  ...
  In such case, the light source of ML must be declared in the materials and methods section so that readers can follow its SPD.
