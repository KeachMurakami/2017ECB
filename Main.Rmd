...
# Introduction
  ...
  Owing to the their regulatability in the incident photon flux density (PFD), the use of the artificial light sources might enhance the reproducibity、制御しやすさ、解釈しやすさ.
  
  @Walters2005JXB warned that the measurement with a different SPD of light from , do not necessarily reflect the functioning of the photosynthesis under growth conditions.
...
# Where and When the interactions should be cared.
  ...
  The impacts of the interaction on the photosynthetic rates should be payed attention when the rates of leaves grown under different PFDs in the FR waveband (FR主張がきつい。怪しいんでしょう？).
  とくに起こりそうなときには注意しなさい
  ...
  This is because FR is not "photosynthetic active" and FR-rich light can induce excessive stem elongation.
