...
CapEED <-
  "Fig. 1  The excitation balance between photosystems in response to wavelength of measuring light. The spectrum was calculated from the absorbance spectra of PSII and PSI complexes in solvent (Hogewoning et al. 2012)."

CapETRs <-
  "Fig. 2  The conceptual diagrams of the effects of the excitation energy distribution between the photosystems (PSII and PSI) on the photosynthetic electron transport rate (ETR). Electron flow (grey lines) and energy flow (black lines) of leaves grown under PSII-light (A, B) and PSI-light (C, D) measured using PSII-light (A, C) and PSI-light (B, D) were shown. "
...
**Abstract**
  ...
  The spectral photon flux density distributions (SPDs) of durign growth and for measurements do not only directly affect the net photosynthetic rate (*P*~n~) but also interacts on it.
  The plausible origin of the interaction, some situations in which the interaction should be concerned, and the selection of appropriate measuring light are summarized.
  *P*~n~ should be measured under *in situ* conditions depending on the purpose of the study.
  ...
  In descriptive studies, *P*~n~ should be evaluated under several SPDs of measuring light to comprehend generalized characteristics.
...
# A plausible origin of the interaction
  ...
  In studies on the acclimation of the photosynthetic apparatus to the SPD of growth light, light with a given SPD is categorized as either PSII- or PSI-light according to whether the excitation energy is preferentially distributed to PSII or PSI [e.g. @Chow_et_al1990PNAS; @Melis1991BBA; @Pfannschmidt_et_al2001JBC; @Fan_et_al2007BBA; @Dietzel_et_al2008FJ; @Pfannschmidt_et_al2009AB; @Dietzel_et_al2011PC; @Hogewoning_et_al2012PC].
  This categorization is defined for a given leaf in the relative scale, not in the absolute scale.
  ...
  Because the photosynthetic electron transport reactions occur in series, the electron transport rate (ETR) through the thylakoid membranes should be limited by the slowest step (Fig. 2).
  **When the excitation energy is in excess at PSII, the fewer energy distributed to PSI results in the smaller photochemical reaction rate in PSI.**
  **This shortage in PSI limits the ETR and therefore the photochemical quantum yield of PSII should be lowered (Fig. 2C).**
  When PSI absorbs the excess excitation energy, the energy distribution to PSII limits the ETR and the yield of PSI should be lowered (Fig. 2B).
  ...
  As a result of these resposes adjusting the EED, the excitation spectrum (Fig. XXX) differs depending on the SPD of grown light.
  The adjustments in the EED properties might help the leaves to keep the high photosynthetic quantum yield under growth light [@Chow_et_al1990PNAS].
  ...
  It is expected that a leaf performs a higher ETR per absorbed photons by the photosystems under measuring light with a PSII/PSI-biased level similar to that of growth light (Fig. 3).
...
# Concluding remarks
  ...
  Although these two approaches might not always be applied for evaluation of the leaf *P*~n~, the interaction should be kept in mind to make circumspect conclusions.
...
```{r, eval = evalFig, fig.cap = CapInteract}
InteractionView
```


```{r, eval = evalFig, htmlcap = CapSPD}
SPDs
```


```{r, eval = evalFig, fig.cap = ""}
```